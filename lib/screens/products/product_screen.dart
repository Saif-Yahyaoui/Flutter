...
class _ProductListState extends State<ProductList> {
  ...
  Future<void> fetchProducts() async {
    try {
      final response = await http.get(Uri.parse('http://localhost:5005/product/products'));
  ...
  Future<void> fetchUsers() async {
    try {
      final response = await http.get(Uri.parse('http://localhost:5005/user/users'));
  ...
  Future<void> deleteProduct(String productId) async {
    try {
      final response = await http.delete(Uri.parse('http://localhost:5005/product/products/$productId'));
